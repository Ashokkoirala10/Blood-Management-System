...
$countQuery = "SELECT COUNT(*) AS total FROM notifications WHERE user_id = $user_id AND role = 'seeker'";
...
$query = "SELECT id, message, is_read, created_at FROM notifications 
          WHERE user_id = $user_id AND role = 'seeker' 
          ORDER BY created_at DESC 
          LIMIT $limit OFFSET $offset";
$result = mysqli_query($conn, $query);

// Mark all as read
mysqli_query($conn, "UPDATE notifications SET is_read = 1 WHERE user_id = $user_id AND role = 'seeker'");
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse justify-content-end custom-collapse" id="navbarNav">
            <ul class="navbar-nav">
                ...
                <li class="nav-item"><a class="nav-link active" href="../notifications/notification_seeker.php"><i class="fas fa-bell"></i> Notifications</a></li>
