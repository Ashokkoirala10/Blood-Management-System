...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (mysqli_query($conn, $sql)) {
        header("Location: ../donors/manage_donors.php");
        exit;
    } else {
    ...
    <div class="request-wrapper">
        <div class="container py-5">
            <div class="update-card">
                <h3 class="text-center">Update donor Profile</h3>
                <form method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-actions d-flex flex-column flex-md-row gap-3 justify-content-center mt-4">
                        <a href="../donors/manage_donors.php" class="custom-btn-outline flex-fill text-center">← Back</a>
                        <button type="submit" class="custom-btn flex-fill">Update Donor</button>
                    </div>
                </form>
            </div>
        </div>
